...
export const DEV_STARTING_POINTS = STARTING_POINTS
...
export const WORLD_GATE_BASE_COST = 3200
export const WORLD_GATE_COST_GROWTH = 2.15
export const BOSS_PREP_SHIELD_COST = 1600
export const BOSS_PREP_OVERCHARGER_COST = 2200
export const BOSS_PREP_STABILIZER_COST = 1800
export const TRANSPORT_INITIAL_CHARGE_REQUIRED = 28
export const TRANSPORT_CHARGE_PER_KILL = 1
export const TRANSPORT_BOSS_CHARGE_BONUS = 20
export const TRANSPORT_CHARGE_GROWTH = 1.9
...
export const PLASMA_UNLOCK_POINTS = 500
export const PULSE_UNLOCK_POINTS = 1000
export const SCATTER_UNLOCK_POINTS = 2500
export const HEAVY_UNLOCK_POINTS = 5000
